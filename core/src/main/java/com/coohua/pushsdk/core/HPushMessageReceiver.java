...
public abstract class HPushMessageReceiver extends BroadcastReceiver {
    ...
    public final void onReceive(Context context, Intent intent) {
        if (intent != null) {
            ...
            try {
                HPushMessage message = (HPushMessage) intent.getSerializableExtra(MESSAGE);
     ...
     * 透传
     */
    public abstract void onReceivePassThroughMessage(Context context, HPushMessage message);

    /**
     * 通知栏消息点击
     */
    public abstract void onNotificationMessageClicked(Context context, HPushMessage message);
